...
public class RotateIJKPlayer implements MediaController.MediaPlayerControl {
    ...
    public RotateIJKPlayer(Context context) {
...
//            Trace.Info("renderView == null");
    ...
    boolean MediaCodecHandleResolutionChange;
    boolean UsingOpenSLES;
    boolean EnableDetachedSurfaceTextureView;
